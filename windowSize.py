...
def preproc(data, window_size):
  ...
  for c, i in enumerate(data, window_size):
    ...
    df_sma5 = df.rolling(window_size).mean().dropna()
...
for i in range(1, 100):
  print(i)
  trainFeats = preproc(train, i)
  testFeats = preproc(test, i)
